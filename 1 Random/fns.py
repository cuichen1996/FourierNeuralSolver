...
def train(config):
    ...
    test_loader1 = CreateTestLoader(config, 33)
    test_loader2 = CreateTestLoader(config, 65)
    test_loader3 = CreateTestLoader(config, 129)
    test_loader4 = CreateTestLoader(config, 257)
...
if __name__ == '__main__':
    ...
    # dir
    config['run_dir']          = "expriments/FNS_{}".format(config["Meta"])
